...
<template>
  <div class="flex items-center rounded-lg bg-white p-4 text-gray-500 shadow dark:bg-gray-800 dark:text-gray-400"
    role="alert">
    ...
    <div v-else-if="toastType == 'success'"
    ...
    <div v-else-if="toastType == 'danger'"
    ...
    <div v-else-if="toastType == 'warning'"
